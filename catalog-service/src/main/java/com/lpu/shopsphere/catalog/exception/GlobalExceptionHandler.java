package com.lpu.shopsphere.catalog.exception;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, Object>> handleGeneric(
    ...
    if (path != null && path.contains("/v3/api-docs")) {
      String details = (ex.getClass().getName() + ": " + (ex.getMessage() != null ? ex.getMessage() : ""));
      return build(HttpStatus.INTERNAL_SERVER_ERROR, details, path, null);
    }
    return build(HttpStatus.INTERNAL_SERVER_ERROR, "Internal server error", path, null);
  }
